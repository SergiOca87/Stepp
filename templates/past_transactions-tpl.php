<?php
/**
* Template Name: Past Transactions
*/
?>
...
<div id="imre-properties">
	...
	<div class="grid-container">
		<div class="properties-header mt-md mb-md">
			...
			<div v-if="closed_properties.length" class="mt-md">
	...
	<!-- grid view -->
	<div class="grid-container xl-container grid-view-wrap past-transactions">
		<div class="grid-x grid-margin-x grid-margin-y">
			<div class="cell large-4 medium-6 property-card" v-for="property in paginated_properties" v-if="property.status != 'active'">
			<span class="property-card__sold">SOLD</span>	
				...
				<div class="property-card__details">
					<div class="property-card__details__inner__wrap">
						...
						<div class="mt-sm mb-sm property-card__details__bottom">
							<div>
								<span v-if="property.location.city" class="property-card__city">{{ property.location.city }} </span>
		...
		<div class="properties-pagination-wrap mt-md mb-xl">
			<pagination :page="page" :per_page="per_page" :total="closed_properties.length" v-if="closed_properties.length"></pagination>
		</div>
	</div>
</div>
