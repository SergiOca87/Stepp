...
class MinikitContact extends Minikit {
	...
	function contact_form_shortcode($atts, $content = null) {
		...
		$html .= '<input type="text" class="input-text" id="mk-name" name="mk-name" value="" placeholder="Your Name"/>';
		$html .= '</div>';
		
		// email field
		$html .= '<div class="input">';
		$html .= '<input type="email" class="input-text" id="mk-email" name="mk-email" value="" placeholder="Email"/>';
		$html .= '</div>';
		...
		// message field
		$html .= '<div class="input">';
		$html .= '<textarea name="mk-message" rows="5" id="mk-message" class="input-text" placeholder="Your Message"></textarea>';
		$html .= '</div>';
		...
		$html .= '<input type="submit" value="Send a message" name="mk-contact" class="btn btn--round" />';
		$html .= '</div>';
		$html .= '</form>';
		$html .= '</div>';
